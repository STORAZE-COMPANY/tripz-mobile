...
import { Modal, TouchableOpacity, View, Text, Switch, StyleSheet, Image, Alert } from 'react-native';
import { Box } from '../Box';
...
import { AppContext, useAppContext } from '@mobile/context';
          ...
          <View style={styles.modalContent}>
            ...
            <View style={styles.menuItems}>
              <View style={styles.menuItem}>
                ...
                <Switch style={styles.SwitchContainerDarkMode}
                  // value={darkMode}
