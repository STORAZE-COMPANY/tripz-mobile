    ...
    const handleNextStep = async () => {
        try {
            ...
            if (error.response?.data?.message.includes("Token inválido")) {
                Alert.alert('Erro', 'Código inválido. Por favor, verifique o código e tente novamente.');
            } else {
            ...
            <Box>
                ...
                <Box alignItems='center'>
                    ...
                    <Box flex={1} alignItems='center' pdTop={20}>
                        <Input type='code' placeholder={(t('PAGES.AUTH.REGISTER.PLACEHOLDERPASSWORD'))}
                            value={code}
                    ...
                    <Box flex={6} alignItems='center'>
                        ...
                        <Box alignItems='center'flexDirection='row' bottom={10} justifyContent='center'>
                    ...
                    <Box flex={2} alignItems='center' bottom={60} >
                        <ButtonDefault width={330} height={40} borderRadius={8}  disabled={isButtonDisabled}  text={(t('PAGES.AUTH.REGISTER.TEXTCODE.BUTTON.CONFIRM'))} color={lightTheme.colors.secondary} onPress={handleNextStep} />
                    </Box>
                </Box>
            </Box>
        </Background>
