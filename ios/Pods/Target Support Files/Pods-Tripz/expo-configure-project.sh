...
with_node \
  ...
  --target "/Users/storaze/Documents/GitHub/tripz-mobile/ios/Pods/Target Support Files/Pods-Tripz/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "@react-native-google-signin/google-signin" "expo-asset" "expo-constants" "expo-file-system" "expo-font" "expo-keep-awake" "expo-linear-gradient" "expo-router"
